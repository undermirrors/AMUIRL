...
--
-- Class LatitudeLongitude as table latitudelongitude
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('amuirl', '20240722144313984', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240722144313984', "timestamp" = now();
